...
void func::Func::Hook(const int32_t &event_type, const std::string &event_function) {
...
std::optional<Any>
func::Func::Event(const int32_t &event_type, const Any &payload) {
...
void func::Func::SetFuncMap(const std::unordered_map<std::string, std::function<Any(Any)>>& func_map) {
  func_map_ = func_map;
}